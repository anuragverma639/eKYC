...
import RobustKYC_BankA from '../../build/contracts/RobustKYC_BankA.json'

// Robust KYC is our usable abstraction, which we'll use through the code below.
var RobustKYC = contract(RobustKYC_BankA);
...
window.App = {
  ...
  verify_name_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.name_by_BankA(id, status, { from: account, gas: 1000000 });
  ...
  verify_email_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.email_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
      App.refreshBankAStatus(id);
      App.refreshBankBStatus(id);
      document.getElementById("loading").setAttribute("hidden", "hidden");
  ...
  verify_phone_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.phone_no_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
      App.refreshBankAStatus(id);
      App.refreshBankBStatus(id);
      document.getElementById("loading").setAttribute("hidden", "hidden");
  ...
  verify_address_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.address_details_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
      App.refreshBankAStatus(id);
      App.refreshBankBStatus(id);
      document.getElementById("loading").setAttribute("hidden", "hidden");
  ...
  verify_blood_group_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.blood_group_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
      App.refreshBankAStatus(id);
      App.refreshBankBStatus(id);
      document.getElementById("loading").setAttribute("hidden", "hidden");
  ...
  verify_image_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.image_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
  ...
  verify_document1_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.document1_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
  ...
  verify_document2_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.document2_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
  ...
  verify_document3_by_bankA: function (status) {
    var id = document.getElementById("customerId").value;
    document.getElementById("loading").removeAttribute("hidden");

    RobustKYC.deployed().then(function (instance) {
      return instance.document3_by_BankA(id, status, { from: account, gas: 1000000 });
    }).then(function (result) {
